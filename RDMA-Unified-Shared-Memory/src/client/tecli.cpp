...
//    int test_size = 1*1024*1024;
    ...
    for(int i=0; i<test_size; i++) alphavalue[i] = rand()%127;
//    int m =65;
...
//    for(int i=2000;i < 4028;i++)
//        printf("%d;%c",i,alphavalue[i]);
//    printf("\n");
//    for(int i=2000;i < 4028;i++)
...
//    if(memcmp(alphavalue, value, BLOCK_SIZE) == 0) {
//        printf("\n\n read success, the same\n");
//    }
//    else {
//        int same_size = 0;
//        for(same_size = 0; same_size < BLOCK_SIZE; same_size++) if(alphavalue[same_size] != value[same_size]) break;
//        printf("\n\n read failed, not the same, same_size=%d\n", same_size);
//    }
